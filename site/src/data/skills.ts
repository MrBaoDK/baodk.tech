...
export const skills: Skill[] = [
  {
    ...
    description: "Designing scalable data pipelines, ETL/ELT workflows, and data warehouse architectures",
    technologies: [
      "Python", "SQL", "Apache Airflow", "Azure Data Factory",
      "Spark", "Kafka", "ETL/ELT", "Data Modeling"
    ],
    icon: "📊"
  },
  {
  ...
  },
  {
    ...
    technologies: [
      ...
      "Podman", "Jenkins", "Azure DevOps", "Azure SQL"
    ],
    icon: "☁️"
  },
  {
  ...
  },
  {
    ...
    technologies: [
      ...
      "SAP", "AWS Redshift", "Supabase", "ODBC", "JDBC"
    ],
    icon: "🗄️"
  },
  {
    title: "Manufacturing Intelligence",
    description: "Applying domain expertise in electronics manufacturing analytics and quality systems",
    technologies: [
      "Quality Reporting", "Six Sigma",
      "BOM Analysis", "Statistical Analysis"
    ],
    icon: "🏭"
  }
];
