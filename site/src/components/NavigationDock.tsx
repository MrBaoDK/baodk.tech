...
const navItems = [
  {
    ...
    icon: 'work',
    title: 'Experience',
    desc: 'Experience and written experience and work.',
  },
  {
    id: 'skills',
    icon: 'monitoring',
    title: 'Technical Skills',
    desc: 'Uses and engineering technical skills.',
  },
  {
    id: 'projects',
    icon: 'rocket_launch',
    title: 'Featured Projects',
    desc: 'High-quality your AI featured projects.',
  },
  {
    id: 'testimonials',
    icon: 'chat',
    title: 'Testimonials',
    desc: 'We have questions, news testimonials.',
  },
  {
    id: 'contact',
    icon: 'contact_page',
    title: 'Get in Touch',
    desc: 'Get in touch a contact person for you.',
  },
];
        ...
        {navItems.map((item) => (
          ...
          >
            ...
            <div className='flex flex-col'>
              <h3 className='text-white font-bold text-[10px] md:text-sm uppercase tracking-wider leading-none md:leading-normal'>
                {item.title}
              </h3>
