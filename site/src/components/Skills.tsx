      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="section-header max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-white/50 font-medium">
            ...
            Specialized in AI integration and scale-focused engineering.
          </p>
        </div>
            ...
            <div key={index} className="card group">
              ...
              <div className="flex flex-wrap gap-2">
                {skill.technologies.map((tech, techIndex) => (
                  <span key={techIndex} className="px-3 py-1 rounded-md bg-white/5 text-white/40 text-[10px] font-bold border border-white/5 uppercase tracking-tighter">
                    {tech}
                  </span>
                ))}
              </div>
