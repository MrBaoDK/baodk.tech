...
const Testimonials: React.FC = () => {
  return (
    <section id="testimonials" className="section bg-[var(--color-background)]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-16 border-y border-white/5">
          <div className="text-center group">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 group-hover:text-[var(--color-primary)] transition-colors">50+</div>
            <div className="text-[10px] uppercase font-black tracking-[0.2em] text-white/40">Projects Delivered</div>
          </div>
          <div className="text-center group">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 group-hover:text-[var(--color-primary)] transition-colors">99.9%</div>
            <div className="text-[10px] uppercase font-black tracking-[0.2em] text-white/40">Uptime Achieved</div>
          </div>
          <div className="text-center group">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 group-hover:text-[var(--color-primary)] transition-colors">70%</div>
            <div className="text-[10px] uppercase font-black tracking-[0.2em] text-white/40">Performance Gain</div>
          </div>
          <div className="text-center group">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 group-hover:text-[var(--color-primary)] transition-colors">6+</div>
            <div className="text-[10px] uppercase font-black tracking-[0.2em] text-white/40">Years Experience</div>
          </div>
        </div>
