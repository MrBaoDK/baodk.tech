        ...
        <div className='max-w-6xl mx-auto'>
          <div className='section-header max-w-3xl mx-auto mb-20 text-center'>
            ...
            <p className='text-xl text-white/40 font-medium'>
              Ready to discuss your next breakthrough? Reach out for collaborations on AI
              engineering, MLOps, or high-performance systems.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className='space-y-8 relative z-10'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                  <div className='space-y-2'>
                    <label
                      htmlFor='name'
                      className='text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-primary)] ml-1'
                    >
                      Full Name
                    </label>
                    <input
                ...
                <button
                  type='submit'
                  className='w-full py-6 rounded-2xl bg-white text-black font-black text-sm uppercase tracking-widest hover:bg-[var(--color-primary)] hover:text-white transition-all shadow-xl hover:scale-[1.01]'
                >
                  Initialize Inquiry
                </button>
              </form>
            ...
            <div className='flex flex-col justify-center space-y-12'>
              <div className='space-y-4'>
                <h3 className='text-3xl font-black text-white tracking-tight'>
                  Direct <span className='text-white/20'>Access</span>
                </h3>
                <p className='text-white/40 font-medium leading-relaxed max-w-sm'>
                  Prefer a traditional channel? I'm available across these networks for deep-dive
                  discussions.
                </p>
              </div>
              ...
              <div className='space-y-8'>
                <div className='flex items-center gap-6 group'>
                  ...
                  <div>
                    <p className='text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-1'>
                      Email
                    </p>
