      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='section-header max-w-3xl mx-auto mb-20'>
          ...
          <p className='text-lg text-white/50 font-medium'>
            A career dedicated to excellence in data engineering, quality assurance, and AI
            integration. From enterprise systems to cutting-edge AI automation.
          </p>
        </div>
                      ...
                      <ul className='space-y-3'>
                        {item.achievements.map((achievement, achievementIndex) => (
                          <li key={achievementIndex} className='flex items-start gap-4 group/li'>
                            <span className='material-symbols-outlined text-[var(--color-primary)] text-sm mt-1 transition-transform group-hover/li:scale-125'>
                              check_circle
                            </span>
